...
<!-- diff: includes xmlns declaration for UT -->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:ead="urn:isbn:1-931666-22-9" xmlns:ns2="http://www.w3.org/1999/xlink"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="urn:isbn:1-931666-22-9" exclude-result-prefixes="xsl ead xsi ns2">
...
Changes:
    ...
    06/08/17    CEW     Preserve schema for Utah institutions, see diff
...
-->
  ...
  <!-- diff: remove doctype for UT  -->
  <xsl:output method="xml" indent="yes" />
  
  <!-- diff: preserve namespace -->
...
-->
  ...
  <xsl:template match="ead:eadheader//ead:address/ead:addressline[last()]">
    <!-- diff: add namespace for new element -->
  ...
  <xsl:template match="ead:eadheader/ead:filedesc/ead:titlestmt">
    <!-- diff: add namespace for new element -->
    <titlestmt xmlns="urn:isbn:1-931666-22-9">
...
-->
  ...
  <xsl:template match="ead:archdesc/ead:did/ead:unitid">
    <xsl:element name="{local-name()}">
      ...
      <!-- diff: don't remove US- or us- from mainagencycode -->
        <xsl:attribute name="repositorycode">
        <xsl:value-of select="//ead:eadid/@mainagencycode"/>
        <!-- <xsl:value-of select="//ead:eadid/@mainagencycode"/> -->
      </xsl:attribute>
      <xsl:apply-templates/>
    </xsl:element>
...
<xsl:call-template name="langcodes"/>
  ...
  <xsl:template match="ead:archdesc/ead:controlaccess">
    ...
    <!-- diff: add namespace to new element -->
  ...
  <xsl:template match="ead:eadheader/ead:eadid">
    ...
    <xsl:element name="{local-name()}">
      ...
      <!-- diff: don't remove US- or us- from mainagencycode for UT -->
  ...
  <xsl:template match="//ead:archdesc//ead:dao">
    <xsl:element name="daogrp">
      ...
      <xsl:element name="daoloc">
        <xsl:attribute name="xlink:label">icon</xsl:attribute>
        <xsl:attribute name="xlink:role">text/html</xsl:attribute>
      ...
      <xsl:element name="arc">
        ...
        <xsl:attribute name="xlink:to">icon</xsl:attribute>
